%Script to analyse output of continuousEmotionFluctuation
%% 
...
for nName=1:length(names)
    name=names{nName};
    data=load(['pilot_data/Cont_P53_',name,'_Task.mat']);
    data=data.data;
...
lme=fitlme(T,'RT~ptemot*stimemot+(1|subject)');